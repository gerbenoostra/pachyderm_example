...
PROFILE = default
PROJECT_NAME = hackathon_ds_to_prod
...
ifeq (True,$(HAS_CONDA))
		...
		@echo ">>> Please run `source activate hackathon_ds_to_prod` before running any other make command"
else
...
#	$(PYTHON_INTERPRETER) -m {{ cookiecutter.package_name }}.data.make_dataset $< $@

models/model.p:	dsprod/models/train_model.py
	$(PYTHON_INTERPRETER) -m dsprod.models.train_model $@
